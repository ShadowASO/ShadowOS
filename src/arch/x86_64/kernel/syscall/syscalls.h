...
*--------------------------------------------------------------------------
Este header reune os protótipos de todas as Service Rotinas utilizadas em
syscall.
--------------------------------------------------------------------------*/
#pragma once
...
/* Syscall Service Rotinas. */
syscret_t sys_read(unsigned int fd, char *buf, size_t count);
