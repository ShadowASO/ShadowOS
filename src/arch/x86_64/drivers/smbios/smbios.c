...
phys_addr_t smbios_phys_address = 0;
...
/* Estou criando uma estrutura chamada 'smbios_info'. */
...
static bool calc_checksum(const virt_addr_t ventry, size_t len)
{
	uint8_t sum = 0;
...
/*Procura o endereço inicial da Tabela SMBIOS.*/
...
void smbios_init(void)
{
	...
	if (smbios_info.major != 2 && smbios_info.major != 3)
		kprintf("No SMBIOS entry point found");
